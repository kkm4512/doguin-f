...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      baseApi: 'https://doguin-alb-1242367005.ap-northeast-2.elb.amazonaws.com/api/v1', // API 베이스 URL 등도 여기에 정의할 수 있어
      baseTest: 'https://doguin-alb-1242367005.ap-northeast-2.elb.amazonaws.com',
